    ...
    A: apis::pet::Pet + apis::store::Store + apis::user::User + 'static,
{
    ...
    Router::new()
        ...
        .route("/api/v3/store/order/:order_id",
    ...
    A: apis::pet::Pet,
{
  ...
  let resp = match result {
                                            Ok(rsp) => match rsp {
                                                apis::pet::AddPetResponse::Status200_SuccessfulOperation
                                                    (body)
                                                => {
                                                ...
                                                apis::pet::AddPetResponse::Status400_InvalidInput
                                                => {
                                                  let mut response = response.status(400);
                                                  response.body(Body::empty())
                                                },
                                                apis::pet::AddPetResponse::Status422_ValidationException
                                                => {
...
fn find_pets_by_status_validation(
  ...
  models::FindPetsByStatusQueryParams,
), ValidationErrors>
{
    ...
    A: apis::pet::Pet,
{
      ...
      #[allow(clippy::redundant_closure)]
      let validation = tokio::task::spawn_blocking(move ||
    find_pets_by_status_validation(
        query_params,
    )
  ).await.unwrap();
  ...
  let resp = match result {
                                            Ok(rsp) => match rsp {
                                                apis::pet::FindPetsByStatusResponse::Status200_SuccessfulOperation
                                                    (body)
                                                => {
                                                  let mut response = response.status(200);
                                                  {
    ...
    A: apis::pet::Pet,
{
  ...
  let resp = match result {
                                            Ok(rsp) => match rsp {
                                                apis::pet::FindPetsByTagsResponse::Status200_SuccessfulOperation
                                                    (body)
                                                => {
                                                  let mut response = response.status(200);
                                                  {
    ...
    A: apis::pet::Pet,
{
  ...
  let resp = match result {
                                            Ok(rsp) => match rsp {
                                                apis::pet::GetPetByIdResponse::Status200_SuccessfulOperation
                                                    (body)
                                                => {
                                                  let mut response = response.status(200);
                                                  {
    ...
    A: apis::pet::Pet,
{
  ...
  let resp = match result {
                                            Ok(rsp) => match rsp {
                                                apis::pet::UpdatePetResponse::Status200_SuccessfulOperation
                                                    (body)
                                                => {
                                                  let mut response = response.status(200);
                                                  {
                                                ...
                                                apis::pet::UpdatePetResponse::Status422_ValidationException
                                                => {
                                                  let mut response = response.status(422);
                                                  response.body(Body::empty())
                                                },
...
fn update_pet_with_form_validation(
  ...
  models::UpdatePetWithFormQueryParams,
), ValidationErrors>
{
  path_params.validate()?;
  query_params.validate()?;
...
async fn update_pet_with_form<I, A>(
  ...
  Query(query_params): Query<models::UpdatePetWithFormQueryParams>,
 State(api_impl): State<I>,
) -> Result<Response, StatusCode>
where
    I: AsRef<A> + Send + Sync,
    A: apis::pet::Pet,
{
      ...
      #[allow(clippy::redundant_closure)]
      let validation = tokio::task::spawn_blocking(move ||
    update_pet_with_form_validation(
        path_params,
        query_params,
    )
  ).await.unwrap();
  ...
  let resp = match result {
                                            Ok(rsp) => match rsp {
                                                apis::pet::UpdatePetWithFormResponse::Status400_InvalidInput
                                                => {
                                                  let mut response = response.status(400);
                                                  response.body(Body::empty())
                                                },
    ...
    A: apis::pet::Pet,
{
  ...
  let resp = match result {
                                            Ok(rsp) => match rsp {
                                                apis::pet::UploadFileResponse::Status200_SuccessfulOperation
                                                    (body)
                                                => {
                                                  let mut response = response.status(200);
                                                  {
    ...
    A: apis::store::Store,
{
  ...
  let resp = match result {
                                            Ok(rsp) => match rsp {
                                                apis::store::GetInventoryResponse::Status200_SuccessfulOperation
                                                    (body)
                                                => {
                                                  let mut response = response.status(200);
                                                  {
    ...
    A: apis::store::Store,
{
  ...
  let resp = match result {
                                            Ok(rsp) => match rsp {
                                                apis::store::GetOrderByIdResponse::Status200_SuccessfulOperation
                                                    (body)
                                                => {
                                                  let mut response = response.status(200);
                                                  {
    ...
    A: apis::store::Store,
{
  ...
  let resp = match result {
                                            Ok(rsp) => match rsp {
                                                apis::store::PlaceOrderResponse::Status200_SuccessfulOperation
                                                    (body)
                                                => {
                                                  let mut response = response.status(200);
                                                  {
    ...
    A: apis::user::User,
{
  ...
  let resp = match result {
                                            Ok(rsp) => match rsp {
                                                apis::user::CreateUsersWithListInputResponse::Status200_SuccessfulOperation
                                                    (body)
                                                => {
                                                  let mut response = response.status(200);
                                                  {
